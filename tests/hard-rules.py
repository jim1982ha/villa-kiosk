...
def main() -> int:
    ...
    if not token_file.exists():
        # ⚠️ NOT A PASS. An instrument that reports success when it did not run
        # is the failure this repository has recorded five times over.
        print("  SKIP  the villa's own vocabulary is UNCHECKED — no "
              f"{token_file.relative_to(ROOT)} on this machine.")
