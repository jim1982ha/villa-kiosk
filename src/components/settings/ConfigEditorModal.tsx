...
const TABS: (ModalTab<SettingsTab> & { owner?: true })[] = [
  ...
  // ⚠️ THE BRIEFINGS DOOR MOVED TO THE HEADER BAR IN 2.730.0. It sat here for
  // three releases because the pipeline had just been evicted from the agent's
  // dialog and needed somewhere to live; a subsystem an owner opens weekly does
  // not belong two dialogs deep behind "Advanced". It is its own icon now,
  // beside the agent's.
