...
import {
  ClipboardCheck, ListChecks, Wrench, Wallet, FileText,
  CalendarCog, Gauge,
} from "lucide-react";
...
export type FacilityTab =
  | "cockpit" | "today" | "readiness" | "faults" | "spend"
  | "schedule" | "report";
...
const TABS: { id: FacilityTab; label: string; icon: typeof ListChecks }[] = [
  ...
  // ⚠️ THE TASKS TAB LEFT IN 2.730.0, AND ITS OLD JUSTIFICATION HAD EXPIRED
  // TWICE OVER. It was added because Briefings was gated on `editConfig`, which
